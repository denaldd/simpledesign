...
<html lang="en">
    <head>
        ...
        <title>BABURA – YARKIRYA – KUZUNZUMI ROAD
</title>
...
<ul class="nav navbar-nav">
        ...
        <section class="header-title section-padding">
            <div class="container text-center">
                ...
                <span class="sub-title">Home > BABURA – YARKIRYA – KUZUNZUMI ROAD
</span>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="project-content">
                            <h3>BABURA – YARKIRYA – KUZUNZUMI ROAD

</h3>
                            <p>The main objective of the project was to provide 50.5Km road which links Babura Town to Yarkirya Market/town and Kuzuzumi as well as and many other villages.
<br>
                            ...
                            <ul type="a">
                                ...
                                <li>Construction of 50.5Km double coat bituminous surface dressed road with a carriageway of 7.3 meters, shoulders of 1.5meters and earthen drains on both sides of the road
</li>
<li>Provision of Block drain, box and ring culverts at relevant locations along the entire length of the road.</li>
                            </ul>
                            <br>
...
<li>Works measurement, processing and certification</li>
                            ...
                            <ul class="category">
                                <li><i class="fa fa-user" aria-hidden="true"></i><span class="bold">Client:</span> -- </li>
                                <li><i class="fa fa-calendar" aria-hidden="true"></i><span class="bold">Date:</span> Nov. 2010 – Oct. 2011</li>                            </ul>
                        </div>
                    </div>
                </div>
            </div> 
...
<center><a href="project4.php"><button class="btn btn-primary">Next Project</button></a></center>
<br>

...
<html lang="en">
    <head>
        ...
        <title>Hantsu-Miga-Dangyatum Road
...
<ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="project1.php">Portfolio</a></li>
        ...
        <section class="header-title section-padding">
            <div class="container text-center">
                ...
                <span class="sub-title">Home > Hantsu-Miga-Dangyatum Road
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="project-content">
                            <h3>Hantsu-Miga-Dangyatum Road
New Construction
</h3>
                            <p>The main objective of the project was to provide 21.796Km road, which links Hantsu Town to Miga up to Jahun K/Hausa federal road at Dangyatum town and some other villages in Jahun Local Government area of Jigawa State.<br>
                            The scope of the project entails:
                            <ul type="a">
                                <li>Planning,Feasibility,Study and design of the road/components; pavement, culverts and drains</li>
                                <li>Construction  
Supervision of 21.796KM double coat bituminous surface dressed road with a carriageway of 7.3 meters, shoulders of 1.5meters and earthen drains on both sides of the road.
</li>
<li>Provision of box and ring pipes culverts at relevant places along the entire length of the road</li>
<li>Design and provision drains, retaining walls and outfalls to checkmate flood and erosion.</li>
                            </ul>
                            <br>
                        Summary of the specific scope of the Consultancy services is outlined below:
                        <ul>
                            <li>Study and design </li>
                            <li>Contract administration
And Supervision of construction activities
</li>
<li>Provision of timely and accurate project progress report and </li>
<li>Quality control</li>
<li>Cost control</li>                        
<li>Time control</li>
<li>Witness testing and certification</li>
<li>Works measurement, processing and certification</li>
</ul></p>

                            <ul class="category">
                                <li><i class="fa fa-user" aria-hidden="true"></i><span class="bold">Client:</span> JIGAWA STATE, MINISTRY OF WORKS AND TRANSPORT</li>
                                <li><i class="fa fa-calendar" aria-hidden="true"></i><span class="bold">Date:</span>  Oct. 2008 – Jan. 2010</li>                            </ul>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <center><a href="project2.php"><button class="btn btn-primary">Next Project</button></a></center>
<br>
        ...
        <div id="offcanvas-menu" class="visible-xs visible-sm">
            ...
            <ul class="menu-wrapper">
                ...
                <li><a class="dropmenu" href="#">Services</a></li>
                <li><a class="dropmenu" href="#">Portfolio</a></li>
